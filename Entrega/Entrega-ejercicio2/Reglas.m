function [ Pop, Fitness, Soporte, Confianza] = Reglas( Datos, lchrom, popsize, pcross, pmutation, numintervalos, clase, MAX_GEN, conSobranteEstocastico, conTorneo )
%%function [ Pop, Fitness, Soporte, Confianza, Historia] = Reglas( Datos, lchrom, popsize, pcross, pmutation, numintervalos, clase, MAX_GEN, conSobranteEstocastico, conTorneo )
...
while(gen < MAX_GEN)
    ...
    % 8. Guardo la historia del valor de fitness mas alto para graficar
    %% Historia(gen) = max(Fitness);
end
end
